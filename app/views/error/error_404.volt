  <section id="error-404" class="parallax">
      <div data-parallax="scroll" data-image-src="/img/bg/33.jpg" class="parallax-bg"></div>
            ...
            <div class="container">
              <div class="error-page"><i class="icon-sad"></i>
                <div class="title">
                  ...
                  <h4 class="upper">La página solicitada no fue encontrada en nuestro servidor. No sabemos nada más.              </h4>
                </div>
                ...
                <!-- end of inline form    --><a href="{{ url ("/home") }}" class="btn btn-color">Volver al inicio</a>
              </div>
              <!-- end of error page-->
            </div>
            <!-- end of container    -->
